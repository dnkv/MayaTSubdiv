...
{ 
	...
	status = plugin.registerNode( "updateTCCDataNode",
								  updateTCCDataNode::id,
								  updateTCCDataNode::creator,
								  updateTCCDataNode::initialize );
	if (!status) {
...
//
{
	...
	status = plugin.deregisterNode( updateTCCDataNode::id );
	if (!status) {
